...
function(svg_convert size_list source_file output_pattern)
	...
	# e.g. "-DWANT_DEBUG_BRANDING=ON"
	# e.g. "export WANT_DEBUG_BRANDING=ON"
...
function(find_svg_tool return)
	...
	foreach(tool ${tools})
		...
		execute_process(COMMAND "${tool}" --version ERROR_QUIET OUTPUT_VARIABLE TOOL_FOUND)
	...
	endforeach()
	if(NOT TOOL_FOUND)
		message(FATAL_ERROR "Could not find a viable tool for image conversion")
	endif()
endfunction()
